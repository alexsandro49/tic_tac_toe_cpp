...
void TicTacToe::drawLine(char x, char y, char z, bool floor = false) {
    std::cout << "     |     |     \n";
    colorChar(x);
    std::cout << x << "\033[0m" << "  |";
    colorChar(y);
...
void TicTacToe::colorChar(char color) {
...
void TicTacToe::play() {
    ...
    do {
        ...
        switch (x) {
            case 1:
                if (possibles[0] == '1') { validMove = true; } 
                else { std::cout << "\nJOGADA INVÁLIDA!\n"; }
                break;
            case 2:
                if (possibles[1] == '2') { validMove = true; } 
                else { std::cout << "\nJOGADA INVÁLIDA!\n"; }
                break;
            case 3:
                if (possibles[2] == '3') { validMove = true; } 
                else { std::cout << "\nJOGADA INVÁLIDA!\n"; }
                break;
            case 4:
                if (possibles[3] == '4') { validMove = true; } 
                else { std::cout << "\nJOGADA INVÁLIDA!\n"; }
                break;
            case 5:
                if (possibles[4] == '5') { validMove = true; } 
                else { std::cout << "\nJOGADA INVÁLIDA!\n"; }
                break;
            case 6:
                if (possibles[5] == '6') { validMove = true; } 
                else { std::cout << "\nJOGADA INVÁLIDA!\n"; }
                break;
            case 7:
                if (possibles[6] == '7') { validMove = true; } 
                else { std::cout << "\nJOGADA INVÁLIDA!\n"; }
                break;
            case 8:
                if (possibles[7] == '8') { validMove = true; } 
                else { std::cout << "\nJOGADA INVÁLIDA!\n"; }
                break;
            case 9:
                if (possibles[8] == '9') { validMove = true; } 
                else { std::cout << "\nJOGADA INVÁLIDA!\n"; }
                break;
            default:
                std::cout << "\nJOGADA INVÁLIDA!\n";
